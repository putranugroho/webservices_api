...
const report = async (req, res) => {
    ...
    try {
        ...
        let request_report = await connect_axios(url_collme, 'CMS', 'collme/cis/report', api_key, data_report)
...
const report_periode = async (req, res) => {
    ...
    try {
        ...
        let request_report = await connect_axios(url_collme, 'CMS', 'collme/cis/report/periode', api_key, data_report)
        if (request_report.code !== "000" && request_report.data === null) {
            console.log(request_report);
            res.status(200).send(request_report);
        } else {
